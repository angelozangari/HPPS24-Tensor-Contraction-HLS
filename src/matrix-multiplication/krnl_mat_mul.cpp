...
void matrix_multiplication(float *Ar, float *Ai, coo_meta_t *Am, float *Br,
  ...
  // clang-format off
#pragma HLS INTERFACE m_axi port=Ar bundle=gmem0 depth=64
#pragma HLS INTERFACE m_axi port=Ai bundle=gmem1 depth=64
#pragma HLS INTERFACE m_axi port=Am bundle=gmem2 depth=64
#pragma HLS INTERFACE m_axi port=Br bundle=gmem3 depth=64
#pragma HLS INTERFACE m_axi port=Bi bundle=gmem4 depth=64
#pragma HLS INTERFACE m_axi port=Bm bundle=gmem5 depth=64
#pragma HLS INTERFACE m_axi port=Cr bundle=gmem6 depth=64
#pragma HLS INTERFACE m_axi port=Ci bundle=gmem7 depth=64
#pragma HLS INTERFACE m_axi port=Cm bundle=gmem8 depth=64
