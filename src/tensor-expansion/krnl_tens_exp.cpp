...
#pragma HLS INTERFACE m_axi port=Cr bundle=gmem6 depth=1024 max_write_burst_length=128
#pragma HLS INTERFACE m_axi port=Ci bundle=gmem7 depth=1024 max_write_burst_length=128
#pragma HLS INTERFACE m_axi port=Cm bundle=gmem8 depth=1024 max_write_burst_length=128
