...
## Running the code
This projects utilizes the [just](https://just.systems) command runner.
The main file in the root directory is `justfile`, which loads the env file and contains the following commands:
...
You can code locally on your machine and then run tests remotely on the necstlab machine by syncing the files with rsync:
# TODO

To run the csim: # TODO

To run the cosim: # TODO

To run the cosynth: # TODO